...
public class NotesDB extends SQLiteOpenHelper {
    ...
    // 1002 是次旧版本，此版本只有 id，记录，创建时间，修改时间，图片路径，视频路径，录音路径，拥有者，是否修改标识(8列)
    // 1003 是目前最新版本，此版本有 id，标题，记录，创建时间，修改时间，图片路径，视频路径，录音路径，拥有者，是否修改标识(8列)
    ...
    public static String Create_table_str = Create_table_str_v1003;//创建表的记录必须是最新的版本的
...
//                break;//break是完全不能要的
            ...
            case 1002://次旧版本，此版本只有 id，记录，创建时间，修改时间，图片路径，视频路径，录音路径，拥有者，是否修改标识(8列)
